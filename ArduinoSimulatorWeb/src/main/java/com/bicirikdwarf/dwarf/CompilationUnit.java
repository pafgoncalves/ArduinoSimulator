...
public class CompilationUnit {
	...
	private DebugInfoEntry compileUnit;
        ...
        protected DwLineNumberInformation lines;
	...
	public void parse(ByteBuffer buffer) {
		...
		buffer.position(address + length + initial_length_size);
                ...
                int offset = (int)compileUnit.getAttribValue(DwAtType.DW_AT_stmt_list);
                lines = new DwLineNumberInformation(pointer_size, offset, dwarf32.getElf32Context().getSectionBufferByName(".debug_line"));
                
	}

        public DwLineNumberInformation getDwLineNumberInformation() {
            return lines;
        }
