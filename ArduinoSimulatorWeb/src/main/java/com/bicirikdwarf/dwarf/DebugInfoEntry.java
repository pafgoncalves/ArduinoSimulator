...
public class DebugInfoEntry {
    ...
    public DebugInfoEntry getChild(DwTagType tag) {
        for(DebugInfoEntry ch : getChildren()) {
            if( ch.getAbbrev()!=null && ch.getAbbrev().tag == tag) {
                return ch;
            }
        }
        return null;
    ...
    public Set<DwAtType> getAttribs() {
