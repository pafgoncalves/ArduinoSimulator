 ...
 */
public class SBRTest {
    
    static CPU cpu = null;
    static SBR instance = null;
    ...
    /**
     * Test of execute method, of class SBR.
     */
    @Test
    public void testSBR() {
        int rdAddr = 0;
    ...
    @Test
    public void testSBR3() {
        int rdAddr = 0;
        cpu.getSRAM().setRegister(rdAddr, 0xF0);
        
        //execute
        instance.execute(cpu, rdAddr, 0x0F);
