 ...
 */
public class BCLRTest {
    
    static CPU cpu = null;
    static BCLR instance = null;
    ...
    /**
     * Test of execute method, of class BCLR.
     */
    @Test
    ...
    public void testCopyStorage() {
        ...
        assertEquals(0xBF, cpu.getSRAM().getStatusRegister());
    ...
    public void testInterruptEnable() {
        ...
        assertEquals(0x7F, cpu.getSRAM().getStatusRegister());
